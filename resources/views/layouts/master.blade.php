...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>GudApp</b>System</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>GudApp</b> System</span>
        </a>
...
@include('layouts.sidebar')
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <?php $date = date('Y')?>
        <strong>&copy; {{$date}} - GudApp Management System </strong>
    </footer>
